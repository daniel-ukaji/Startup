    ...
    <section className='pb-32'>
        <div className='flex max-w-6xl mx-auto justify-between'>
            ...
            <div className='flex flex-col justify-center pt-32'>
                <h1 className='text-5xl font-bold max-w-md pb-10 font-Poppins'>Sell quickly, easily, and from anywhere</h1>
                ...
                <div className='space-x-5 mt-10'>
                    <a href="#" className='font-Poppins border pt-2 pb-2 pl-6 pr-6 rounded cursor-pointer bg-[#152C5B] text-white'>Try for Free</a>
                </div>
            </div>
        </div>
    </section>
